...
HACKMD_API_TEAMS_API_ROUTE = join_url(base_url="teams", relative_url=settings.TEAM_PATH)
...
def execute_program_collabwriting_2022():
...
if __name__ == "__main__":
    execute_program_collabwriting_2022()
