...
def create_collabwriting(notes_title: list, notes_info: list) -> None:
    log = []
...
def update_collabwriting(notes_info: list) -> None:
...
def output_collabwriting(notes_title: list, notes_info: list) -> None:
